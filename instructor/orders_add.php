...
$sql = "SELECT * FROM books INNER JOIN Publisher ON books.isbn = Publisher.isbn WHERE Publisher.isbn =".$_GET['view'];
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);

$sql2 = "SELECT * FROM courses WHERE course_id =".$_GET['viewt'];
   ...
   <div class="col-sm-8 main-section">
     <div class="modal-content">
      <form method="POST" class="col-12">
        ...
        <label class="labels">Place Order</label>
        ...
        <div class="form-group">
          <input type="hidden" class="form-control" value="<?php echo $row['name']; ?>" name="publisher">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <input type="hidden" class="form-control" value="<?php echo $row2['ins_name']; ?>" name="ins_name">
        </div>
        <div class="form-group">
          <input type="hidden" class="form-control" value="<?php echo $row2['ins_phone']; ?>" name="ins_phone">
        </div>
        <div class="form-group">
          <input type="hidden" class="form-control" value="<?php echo $row2['ins_email']; ?>" name="ins_email">
        </div>
        <div class="form-group">
          <input type="hidden" class="form-control" value="<?php echo $row2['dir_name']; ?>" name="dir_name">
        </div>
        <div class="form-group">
          <input type="hidden" class="form-control" value="<?php echo $row2['dir_phone']; ?>" name="dir_phone">
        </div>
        <div class="form-group">
          <input type="hidden" class="form-control" value="<?php echo $row2['dir_email']; ?>" name="dir_email">
        </div>
        <div class="form-group">
          <input type="hidden" class="form-control" value="<?php echo $row2['head_name']; ?>" name="head_name">
        </div>
        <div class="form-group">
          <input type="hidden" class="form-control" value="<?php echo $row2['head_phone']; ?>" name="head_phone">
        </div>
        <div class="form-group">
          <input type="hidden" class="form-control" value="<?php echo $row2['head_email']; ?>" name="head_email">
        </div>
        <div class="form-group">
        ...
        <!-- Send confirmation email -->
                ...
                $message = 'Dear ' . $ins_name . ',\nYour order was successfully placed!\n\nTextBook Interchange';

                // Always set content-type when sending HTML email
                $headers = 'From: admin@bookinterchange.atwebpages.com'. "\r\n" . 
                    'Reply-To: admin@bookinterchange.atwebpages.com' . "\r\n" . 

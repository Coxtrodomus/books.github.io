...
include_once('header.php');
        ...
        $sql = mysqli_query($conn, "INSERT INTO orders (isbn, title, author, publisher, course, semester, start_date, campus, ins_name, ins_phone, ins_email, dir_name, dir_phone, dir_email, head_name, head_phone, head_email, total, status, comments) 
        VALUES ('$isbn', '$title', '$author', '$publisher', '$course', '$semester', '$date', '$campus', '$ins_name', '$ins_phone', '$ins_email', '$dir_name', '$dir_phone', '$dir_email', '$head_name', '$head_phone', '$head_email', '$total', '$status', '$comments')");
...
<div class="modal-dialog text-center">
  ...
  <div class="form-group">
    ...
    <input type="date" class="form-control" name="date" min="01-01-2019" required="" oninvalid="this.setCustomValidity('Please enter a date')" oninput="setCustomValidity('')">
  </div>
  <div class="form-group">
